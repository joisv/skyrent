            ...
            @empty(!$iphones)
                <div class="space-y-2 flex flex-col justify-center items-center">
                    @forelse ($iphones as $iphone)
                        ...
                        <button type="button" class="bg-slate-900 p-2 text-white w-fit px-5">sewa sekarang</button
                            type="button">
                    @empty
                        <p class="text-center" wire:loading.remove>No iPhones available at the moment.</p>
                    @endforelse
