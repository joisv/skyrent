<div >
    ...
    <script>
        window.addEventListener('livewire:init', function() {
            ...
            $('#summernote_terms_conditions').summernote({
                tabsize: 2,
                ...
                callbacks: {
                    onInit: function() {
                        $('#summernote_terms_conditions').summernote('code', @json($terms_conditions));
                        $('.note-group-select-from-files').first().remove();
                    },
                    onChange: function(contents, $editable) {
                        @this.set('terms_conditions', contents, true);
                    }
                }
            });
