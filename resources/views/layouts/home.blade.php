            ...
            <div>
                ...
                <div class="flex w-full justify-between items-start">
                    <div class="w-[50%] h-[50%] md:w-40 md:h-40 mt-5">
                        <h3 class="text-gray-500 font-semibold text-sm md:text-base">Jl. KH. Imam Bahri, Dusun Kopen,
                            Desa
                            Genteng Kulon, Kec.
