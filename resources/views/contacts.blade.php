        ...
        <div class="flex justify-center items-center w-full h-screen ">
                ...
                <div class=" space-y-10">
                    ...
                    <div class="flex items-start space-x-7">
                        ...
                        <div class="text-lg font-semibold">
                            ...
                            <div class="text-gray-700 text-base font-medium">
                                <p class="text-gray-700 text-base">Our friendly team are here to help you</p>
                                <span>jois@vanka.com</span>
                            </div>
                        </div>
                    </div>
                    {{-- Visit Us --}}
                    <div class="flex items-start space-x-7">
                        ...
                        <div class="text-lg font-semibold">
                            <h1>Visit Us</h1>
                            <div class="text-gray-700 text-base font-medium">
                                <p class="text-gray-700 text-base">Come and say hello at our HQ</p>
                                <span>jl.Ahmad Yani lampu merah maron no 24</span>
                            </div>
                        </div>
                    </div>
                    {{-- Visit Us --}}
                    <div class="flex items-start space-x-7">
                        <svg width="33px" height="33px" viewBox="0 0 24 24" fill="none"
                            ...
                            <g id="SVGRepo_iconCarrier">
                                <path
                                    ...
                                    stroke="#000000" stroke-width="1.224" stroke-linecap="round"
                                    stroke-linejoin="round">
                                </path>
                            </g>
                        </svg>
                        <div class="text-lg font-semibold">
                            <h1>Call Us</h1>
                            <div class="text-gray-700 text-base font-medium">
                                <p class="text-gray-700 text-base">Monday - Sunday 9am to 9pm</p>
                                <span>+6283246585647</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="flex space-x-3">
                    <a target="_blank" class="border-2 border-gray-200 rounded-lg p-2" href="{{ $settings->youtube }}">
                    ...
                    <a  target="_blank" class="border-2 border-gray-200 rounded-lg p-2" href="{{ $settings->tiktok }}">
                    ...
                    <a  target="_blank" class="border-2 border-gray-200 rounded-lg p-2" href="{{ $settings->instagram }}">
                    ...
                    <a  target="_blank" class="border-2 border-gray-200 rounded-lg p-2" href="{{ $settings->facebook }}">
            ...
            <div class="w-[60%] bg-sky-300 p-9 rounded-3xl">
                ...
                <div class="mt-10 space-y-8">
                    <div class="w-full">
                        <input type="text"
                            class="border-x-0 border-t-0 w-full placeholder:text-slate-900 border-b-2 border-b-black focus:ring-0 py-2 px-1 focus:border-t-0 focus:border-b-sky-500 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:border-blue-500 bg-transparent"
                            placeholder="Your name" id="name">
                    </div>
                    <div class="w-full">
                        <input type="text"
                            class="border-x-0 border-t-0 w-full placeholder:text-slate-900 border-b-2 border-b-black focus:ring-0 py-2 px-1 focus:border-t-0 focus:border-b-sky-500 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:border-blue-500 bg-transparent"
                            placeholder="yourcompany@mail.com" id="name">
                    </div>
                    <div class="w-full">
                        <input type="text"
                            class="border-x-0 border-t-0 w-full placeholder:text-slate-900 border-b-2 border-b-black focus:ring-0 py-2 px-1 focus:border-t-0 focus:border-b-sky-500 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:border-blue-500 bg-transparent"
                            placeholder="Tell us about your're idea" id="name">
                    </div>
                </div>
                <button type="button" class="w-full py-4 bg-black text-white text-lg font-semibold mt-10">Let's get
                    started</button>
            </div>
        </div>
    </div>
